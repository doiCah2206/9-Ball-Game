...
((loadState.init = function () {
    ...
    (loadState.resizeGame = function (e, s) {
        if (!this.loaderInfo || !this.loaderInfo.loaderCanvas) return;
        ...
        String(
            Math.abs(a - document.getElementById("mygame").clientHeight) / 2,
        );
    ...
    (loadState.preload = function () {
        (this.load.spritesheet(
            ...
            this.load.spritesheet(
                "turnArrow",
                "assets/img/turnArrow.png",
                128,
                128,
            ),
            this.load.spritesheet(
                "pVpButton",
                "assets/img/pVpButton.png",
                460,
                195,
            ),
            this.load.spritesheet(
            ...
            this.load.image(
                "more_games",
                window.famobi.getBrandingButtonImage(),
            ),
